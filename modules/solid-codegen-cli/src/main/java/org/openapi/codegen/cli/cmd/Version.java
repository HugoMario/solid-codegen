...
public class Version implements Runnable {
    ...
    public static final String SWAGGER_CODEGEN_VERSION = "solid-codegen.version";
    public static final String SWAGGER_CODEGEN_GENERATORS_VERSION = "solid-codegen.generators.version";
