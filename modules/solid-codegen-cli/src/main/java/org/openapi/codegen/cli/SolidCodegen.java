package org.openapi.codegen.cli;

import org.openapi.codegen.cli.cmd.Generate;
 ...
 * <p>
 * Command line interface for swagger codegen use `solid-codegen-cli.jar help` for more info
 *
 * @since 2.1.3-M1
 */
public class SolidCodegen {


    private static Logger LOGGER = LoggerFactory.getLogger(SolidCodegen.class);
    ...
    public static void main(String[] args) {
        ...
        final ArgumentParser codegenParser = ArgumentParsers.newFor("solid-codegen").build();
