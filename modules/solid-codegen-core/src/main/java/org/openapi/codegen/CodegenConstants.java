...
public class CodegenConstants {
    ...
    public static final String GIT_USER_ID_DESC = "Git user ID, e.g. HugoMario.";

    public static final String GIT_REPO_ID = "gitRepoId";
    public static final String GIT_REPO_ID_DESC = "Git repo ID, e.g. solid-codegen.";

    public static final String GIT_REPO_BASE_URL = "gitRepoBaseURL";
    public static final String GIT_REPO_BASE_URL_DESC = "Git repo Base URL, e.g. solid-codegen.";
    ...
    public static final String HTTP_USER_AGENT_DESC = "HTTP user agent, e.g. codegen_csharp_api_client, default to 'solid-codegen/{packageVersion}}/{language}'";
    ...
    public static final String IGNORE_FILE_OVERRIDE_DESC = "Specifies an override location for the .solid-codegen-ignore file. Most useful on initial generation.";
    ...
    public static final String IS_ENUM_EXT_NAME = VendorExtendable.PREFIX_IS + "enum";
    public static final String IS_ALIAS_EXT_NAME = VendorExtendable.PREFIX_IS + "alias";
    public static final String IS_ARRAY_MODEL_EXT_NAME = VendorExtendable.PREFIX_IS + "array-model";
    public static final String HAS_VARS_EXT_NAME = VendorExtendable.PREFIX_HAS + "vars";
    public static final String HAS_ENUMS_EXT_NAME = VendorExtendable.PREFIX_HAS + "enums";
    public static final String HAS_MORE_MODELS_EXT_NAME = VendorExtendable.PREFIX_HAS + "more-models";
    public static final String HAS_REQUIRED_EXT_NAME = VendorExtendable.PREFIX_HAS + "required";
    public static final String HAS_OPTIONAL_EXT_NAME = VendorExtendable.PREFIX_HAS + "optional";
    public static final String HAS_CHILDREN_EXT_NAME = VendorExtendable.PREFIX_HAS + "children";
    public static final String HAS_ONLY_READ_ONLY_EXT_NAME = VendorExtendable.PREFIX_HAS + "only-read-only";
    public static final String HAS_INNER_OBJECT_NAME = VendorExtendable.PREFIX_HAS + "inner-object";

    public static final String IS_SIMPLE_TYPE_EXT_NAME = VendorExtendable.PREFIX_IS + "simple-type";
    public static final String IS_NULLABLE_EXT_NAME = VendorExtendable.PREFIX_IS + "nullable";
    public static final String IS_PRIMITIVE_TYPE_EXT_NAME = VendorExtendable.PREFIX_IS + "primitive-type";
    public static final String IS_OBJECT_EXT_NAME = VendorExtendable.PREFIX_IS + "object";
    public static final String IS_CONTAINER_EXT_NAME = VendorExtendable.PREFIX_IS + "container";
    public static final String IS_NOT_CONTAINER_EXT_NAME = VendorExtendable.PREFIX_IS + "not-container";
    public static final String IS_DEFAULT_EXT_NAME = VendorExtendable.PREFIX_IS + "default";
    public static final String IS_STRING_EXT_NAME = VendorExtendable.PREFIX_IS + "string";
    public static final String IS_NUMERIC_EXT_NAME = VendorExtendable.PREFIX_IS + "numeric";
    public static final String IS_INTEGER_EXT_NAME = VendorExtendable.PREFIX_IS + "integer";
    public static final String IS_LONG_EXT_NAME = VendorExtendable.PREFIX_IS + "long";
    public static final String IS_NUMBER_EXT_NAME = VendorExtendable.PREFIX_IS + "number";
    public static final String IS_FLOAT_EXT_NAME = VendorExtendable.PREFIX_IS + "float";
    public static final String IS_DOUBLE_EXT_NAME = VendorExtendable.PREFIX_IS + "double";
    public static final String IS_BYTE_ARRAY_EXT_NAME = VendorExtendable.PREFIX_IS + "byte-array";
    public static final String IS_BINARY_EXT_NAME = VendorExtendable.PREFIX_IS + "binary";
    public static final String IS_FILE_EXT_NAME = VendorExtendable.PREFIX_IS + "file";
    public static final String IS_BOOLEAN_EXT_NAME = VendorExtendable.PREFIX_IS + "boolean";
    public static final String IS_DATE_EXT_NAME = VendorExtendable.PREFIX_IS + "date";
    public static final String IS_DATE_TIME_EXT_NAME = VendorExtendable.PREFIX_IS + "date-time";
    public static final String IS_UUID_EXT_NAME = VendorExtendable.PREFIX_IS + "uuid";
    public static final String IS_LIST_CONTAINER_EXT_NAME = VendorExtendable.PREFIX_IS + "list-container";
    public static final String IS_MAP_CONTAINER_EXT_NAME = VendorExtendable.PREFIX_IS + "map-container";
    public static final String IS_READ_ONLY_EXT_NAME = VendorExtendable.PREFIX_IS + "read-only";
    public static final String IS_INHERITED_EXT_NAME = VendorExtendable.PREFIX_IS + "inherited";
    public static final String IS_XML_ATTRIBUTE_EXT_NAME = VendorExtendable.PREFIX_IS + "xml-attribute";
    public static final String IS_XML_WRAPPED_EXT_NAME = VendorExtendable.PREFIX_IS + "xml-wrapped";
    public static final String IS_MULTIPART_EXT_NAME = VendorExtendable.PREFIX_IS + "multipart";
    public static final String IS_RESPONSE_BINARY_EXT_NAME = VendorExtendable.PREFIX_IS + "response-binary";
    public static final String IS_RESPONSE_FILE_EXT_NAME = VendorExtendable.PREFIX_IS + "response-file";
    public static final String IS_RESTFUL_INDEX_EXT_NAME = VendorExtendable.PREFIX_IS + "restful-index";
    public static final String IS_RESTFUL_SHOW_EXT_NAME = VendorExtendable.PREFIX_IS + "restful-show";
    public static final String IS_RESTFUL_CREATE_EXT_NAME = VendorExtendable.PREFIX_IS + "restful-create";
    public static final String IS_RESTFUL_UPDATE_EXT_NAME = VendorExtendable.PREFIX_IS + "restful-update";
    public static final String IS_RESTFUL_DESTROY_EXT_NAME = VendorExtendable.PREFIX_IS + "restful-destroy";
    public static final String IS_RESTFUL_EXT_NAME = VendorExtendable.PREFIX_IS + "restful";
    public static final String IS_DEPRECATED_EXT_NAME = VendorExtendable.PREFIX_IS + "deprecated";

    public static final String IS_FORM_EXT_NAME = VendorExtendable.PREFIX_IS + "form";

    public static final String IS_FORM_PARAM_EXT_NAME = VendorExtendable.PREFIX_IS + "form-param";
    public static final String IS_QUERY_PARAM_EXT_NAME = VendorExtendable.PREFIX_IS + "query-param";
    public static final String IS_PATH_PARAM_EXT_NAME = VendorExtendable.PREFIX_IS + "path-param";
    public static final String IS_HEADER_PARAM_EXT_NAME = VendorExtendable.PREFIX_IS + "header-param";
    public static final String IS_COOKIE_PARAM_EXT_NAME = VendorExtendable.PREFIX_IS + "cookie-param";
    public static final String IS_BODY_PARAM_EXT_NAME = VendorExtendable.PREFIX_IS + "body-param";
    public static final String IS_COLLECTION_FORMAT_MULTI_EXT_NAME = VendorExtendable.PREFIX_IS + "collection-format-multi";

    public static final String IS_BASIC_EXT_NAME = VendorExtendable.PREFIX_IS + "basic";
    public static final String IS_BEARER_EXT_NAME = VendorExtendable.PREFIX_IS + "bearer";
    public static final String IS_OAUTH_EXT_NAME = VendorExtendable.PREFIX_IS + "oauth";
    public static final String IS_API_KEY_EXT_NAME = VendorExtendable.PREFIX_IS + "api-key";
    public static final String IS_KEY_IN_QUERY_EXT_NAME = VendorExtendable.PREFIX_IS + "key-in-query";
    public static final String IS_KEY_IN_HEADER_EXT_NAME = VendorExtendable.PREFIX_IS + "key-in-header";
    public static final String IS_CODE_EXT_NAME = VendorExtendable.PREFIX_IS + "code";
    public static final String IS_PASSWORD_EXT_NAME = VendorExtendable.PREFIX_IS + "password";
    public static final String IS_APPLICATION_EXT_NAME = VendorExtendable.PREFIX_IS + "application";
    public static final String IS_IMPLICIT_EXT_NAME = VendorExtendable.PREFIX_IS + "implicit";

    public static final String IS_GET_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "get-method";
    public static final String IS_POST_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "post-method";
    public static final String IS_PUT_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "put-method";
    public static final String IS_DELETE_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "delete-method";
    public static final String IS_HEAD_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "head-method";
    public static final String IS_TRACE_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "trace-method";
    public static final String IS_PATCH_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "patch-method";
    public static final String IS_OPTIONS_METHOD_EXT_NAME = VendorExtendable.PREFIX_IS + "options-method";

    public static final String HAS_MORE_EXT_NAME = VendorExtendable.PREFIX_HAS + "more";
    public static final String HAS_MORE_NON_READ_ONLY_EXT_NAME = VendorExtendable.PREFIX_HAS + "more-non-read-only";
    public static final String HAS_VALIDATION_EXT_NAME = VendorExtendable.PREFIX_HAS + "validation";
    public static final String HAS_AUTH_METHODS_EXT_NAME = VendorExtendable.PREFIX_HAS + "auth-methods";
    public static final String HAS_CONSUMES_EXT_NAME = VendorExtendable.PREFIX_HAS + "consumes";
    public static final String HAS_PRODUCES_EXT_NAME = VendorExtendable.PREFIX_HAS + "produces";
    public static final String HAS_PARAMS_EXT_NAME = VendorExtendable.PREFIX_HAS + "params";
    public static final String HAS_OPTIONAL_PARAMS_EXT_NAME = VendorExtendable.PREFIX_HAS + "optional-params";
    public static final String HAS_REQUIRED_PARAMS_EXT_NAME = VendorExtendable.PREFIX_HAS + "required-params";
    public static final String HAS_REFERENCE_EXT_NAME = VendorExtendable.PREFIX_HAS + "reference";
    public static final String HAS_HEADERS_EXT_NAME = VendorExtendable.PREFIX_HAS + "headers";
